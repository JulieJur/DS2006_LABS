...
# added variables  to the code to get the two errors fixed.
# player1_roll = 0
# player2_roll = 0
...
)  # NameError: name 'player1_roll' is not defined

player1_roll = random.randint(1, 6)
print("Player 1 rolled: ", player1_roll)
print(
    "Player 2 rolled: ", player2_roll
)  # NameError: name 'player2_roll' is not defined
